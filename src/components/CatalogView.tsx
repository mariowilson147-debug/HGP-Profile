        ...
        {categories.map(category => {
          ...
          return (
            <div key={category} className="w-full">
              <div className="mb-10 border-b border-[#222] pb-4 flex items-end justify-between">
                <h2 className="text-3xl font-serif text-[#fefefe] uppercase tracking-wider">{category}</h2>
                <span className="text-[#888] text-sm font-medium tracking-widest uppercase">{categoryProducts.length} Items</span>
              </div>
